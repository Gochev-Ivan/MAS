...
if clientID!=-1:
    ...
    emptyBuff = bytearray()
    res,retInts,retFloats,retStrings,retBuffer=vrep.simxCallScriptFunction(clientID,'Quadricopter',vrep.sim_scripttype_childscript,'qc_propeller_v',[],[6,6,6,6],[],emptyBuff,vrep.simx_opmode_blocking)
